-- JAV BURMA Telegram Mini App - Complete Database Setup
...
SELECT COUNT(*) as total_chats FROM customer_chats;
SELECT COUNT(*) as total_messages FROM chat_messages;

-- ============================================
-- SETUP COMPLETE ✅
-- ============================================
-- Tables created: customer_chats, chat_messages, ads_management
-- Channels seeded: 35 channels with logos and links
